...
if("TRUE" STREQUAL "TRUE")
  set(pcl_test_SOURCE_PREFIX /home/tianxl/learning_3d/pcl/pcl_ws/src/pcl_test)
  set(pcl_test_DEVEL_PREFIX /home/tianxl/learning_3d/pcl/pcl_ws/devel)
  set(pcl_test_INSTALL_PREFIX "")
  set(pcl_test_PREFIX ${pcl_test_DEVEL_PREFIX})
else()
  set(pcl_test_SOURCE_PREFIX "")
  set(pcl_test_DEVEL_PREFIX "")
  set(pcl_test_INSTALL_PREFIX /home/tianxl/learning_3d/pcl/pcl_ws/install)
...
if(NOT "/home/tianxl/learning_3d/pcl/pcl_ws/src/pcl_test/include " STREQUAL " ")
  set(pcl_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/tianxl/learning_3d/pcl/pcl_ws/src/pcl_test/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tianxl/learning_3d/pcl/pcl_ws/src/pcl_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pcl_test_NUM_DUMMY_TARGETS)
      set(pcl_test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pcl_test::wrapped-linker-option${pcl_test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pcl_test_NUM_DUMMY_TARGETS "${pcl_test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pcl_test::wrapped-linker-option${pcl_test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pcl_test_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tianxl/learning_3d/pcl/pcl_ws/devel/lib;/home/tianxl/learning_3d/pcl/pcl_ws/devel/lib;/home/tianxl/learning_3d/pcl/pw_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pcl_test_EXPORTED_TARGETS ${${pcl_test_dep}_EXPORTED_TARGETS})
endforeach()
